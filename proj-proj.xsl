...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:template match="/">
		<html>
			<head>
				<title>Expéditions pour les projets Chronopost - Tri par nom de projet décroissant</title>
			</head>
			<body>
					<div id="titre">
				<table border="3"  cellspacing="4" cellpadding="2" align="center">
					<caption align="center">
						Tri par nom de projet décroissant
					</caption>
					<colgroup>
				...
				<table border="3"  cellspacing="4" cellpadding="2" align="center">
					...
					<xsl:sort select="proj" order="descending" />
						<tr>
